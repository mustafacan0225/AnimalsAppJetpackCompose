...
import com.mustafacan.domain.usecase.dogs.sharedpreference.GetTabTypeUseCase
import com.mustafacan.domain.usecase.dogs.sharedpreference.SaveTabTypeUseCase
...
class DogDetailViewModel @Inject constructor(
    ...
    fun load(pagerState: PagerState, scope: CoroutineScope) {
        viewModelScope.launch {
            ...
            sendEvent(
                DogDetailScreenUiStateManager.DogDetailScreenEvent.Load(
                    dog = dog!!,
    ...
    fun settingsUpdated(viewTypeForTab: ViewTypeForTab) {
        viewModelScope.launch {
            ...
            sendEvent(
                DogDetailScreenUiStateManager.DogDetailScreenEvent.SettingsUpdated(
                    viewTypeForTab
                )
            )
        }
