package com.mustafacan.core.components.settings
    ...
    Surface(
        ...
        Box(
            ...
            Column(modifier = Modifier.padding(20.dp)) {
                ...
                androidx.compose.material3.Text(
                    text = stringResource(id = com.mustafacan.core.R.string.view_mode_tab_description),
                    fontWeight = FontWeight.Bold
                )
                ...
                Button(modifier = Modifier
                    ...
                    androidx.compose.material3.Text(
                        text = stringResource(id = com.mustafacan.core.R.string.settings_apply),
                        color = Color.White
                    )
                }
