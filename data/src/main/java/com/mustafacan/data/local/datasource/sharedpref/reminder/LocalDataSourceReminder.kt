package com.mustafacan.data.local.datasource.sharedpref.reminder

import com.mustafacan.data.local.datasource.sharedpref.SharedPreferencesManager
import javax.inject.Inject

class LocalDataSourceReminder @Inject constructor(private val sharedPreferencesManager: SharedPreferencesManager) {
